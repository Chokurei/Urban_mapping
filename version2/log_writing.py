...
#        print('Load model: {}'.format(model_name))
        if label_mode:
            ...
            vector_images = args[4]
            test_time = args[5]
            inter_over_unions_list = args[6]
            accuracy_list = args[7]
            
            print('Testing image pieces: '+str(len(vector_images)))
            for i in range(len(vector_images)):
                ...
                print('       Testing_time: '+ str(test_time[i])+'    Every image:'+str((test_time[i])/len(vector_images)))
