...
def get_patches_test_with_label(raster_image, vector_image, *args, **kwargs):
    """
    ...
    **kwargs :
    ...
    Returns
    -------
    raster_patch_array : uint8
        4dim (num, patch_size, patch_size, 3)
    vector_patch_array : uint8
        4dim (num, patch_size, patch_size, 2)
    """   
    patch_size = kwargs['patch_size']
